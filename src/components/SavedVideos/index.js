...
class SavedVideos extends Component {
  ...
  renderEmptyView = isDark => {
    const emptyViewHeading = isDark
      ? 'light-empty-heading-text'
      : 'dark-empty-heading-text'
    const bgColor = isDark ? '#0f0f0f' : '#ebebeb'
    const emptyViewDescription = isDark ? 'light-text' : 'dark-text'
    return (
      <EmptyViewContainer bgColor={bgColor}>
        <EmptyViewImage
          ...
          alt="no saved videos"
        />
        <h1 className={emptyViewHeading}>No saved videos found</h1>
        <p className={emptyViewDescription}>
